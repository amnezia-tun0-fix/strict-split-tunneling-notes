...
A test build of the three together, signed with my own key: [v5.0.3.1-strict.3](https://github.com/amnezia-tun0-fix/amnezia-client/releases/tag/v5.0.3.1-strict.3). It cannot be installed over the official app — the release notes say what to back up first.
